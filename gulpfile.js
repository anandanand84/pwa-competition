...
gulp.task('compressJs', function() {
  return gulp.src('dist/elements/elements.js', {base: './'})
    .pipe(minify({
      ext: {
        min : '.js',
        src : '-orig.js'
...
gulp.task('vulcanize', function() {
  return gulp.src('app/elements/elements.html')
    ...
    //.pipe(crisper()) //crisper doenst work properly with service worker async, elements gets loaded first before polymer
...
gulp.task('cache-config', function(callback) {
  ...
  glob([
    ...
    '{scripts,styles,elements,images}/**/*.*'],
...
gulp.task('serve', ['styles', 'elements'], function() {
  ...
  var proxyOptions = url.parse('https://realtimestockscreener.com/api');
  ...
  browserSync({
    ...
    server: {
      baseDir: ['.tmp', 'app'],
      middleware: [proxy(proxyOptions),historyMiddleWare]
    }
  });
  //,historyApiFallback({
  //  rewrites: [
...
gulp.task('serve:dist', ['default'], function() {
  ...
  gulp.watch(['app/**/*.html'], ['vulcanize',reload]);
  gulp.watch(['app/**/*.js'],  ['vulcanize',reload]);
  gulp.watch(['app/styles/**/*.css'], ['styles', reload]);
  gulp.watch(['app/elements/**/*.css'], ['elements', reload]);
  gulp.watch(['app/images/**/*'], reload);
...
gulp.task('deploy', function() {
  gulp.src('dist')
    .pipe(rsync({
      root: 'dist',
      username : 'root',
      hostname: 'traderslab.in',
      destination: '/hosting/tlab-screener/',
      recursive: true
    }));
});
